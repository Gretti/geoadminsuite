...
*/        
        return {
            ...
            init : function(){
                    ...
                    var root = new Ext.tree.TreeNode({text: i18n.components, id:'source',expanded : true});
                    components.setRootNode(root);
                    var nodeOL = new Ext.tree.TreeNode({text:i18n.openlayers_controls, id:'OLCtrl',expanded : true});
                    var nodeMF = new Ext.tree.TreeNode({text:i18n.mapfish_controls, id:'MFCtrl',expanded : true});
                    
                    var subNodesOL = [
                        new Ext.tree.TreeNode({text:'Layer Switcher&nbsp;&nbsp;&nbsp;&nbsp;<img src="styles/cog_add.png" id="img.OL_LayerSwitcher">',
                            id:'OL_LayerSwitcher', leaf:true}),
                        new Ext.tree.TreeNode({text:'Mouse Position&nbsp;&nbsp;&nbsp;&nbsp;<img src="styles/cog_add.png" id="img.OL_MousePosition">',
                            id:'OL_MousePosition', leaf:true}),
                        new Ext.tree.TreeNode({text:'Overview Map&nbsp;&nbsp;&nbsp;<img src="styles/cog_add.png" id="img.OL_OverviewMap">',
                            id:'OL_OverviewMap',   leaf:true}),
                        new Ext.tree.TreeNode({text:'Editing Toolbar&nbsp;&nbsp;&nbsp;&nbsp;<img src="styles/cog_add.png" id="img.OL_EditingToolbar">',
                            id:'OL_EditingToolbar',leaf:true}),
                        new Ext.tree.TreeNode({text:'Scale&nbsp;&nbsp;&nbsp;&nbsp;<img src="styles/cog_add.png" id="img.OL_Scale">',
...
//'OL_PanZoom':       {tool:'new OpenLayers.Control.PanZoom()',incompatible:['OL_PanZoomBar']},
                    ...
                    cpPublisherCpts = new Ext.Panel({
                        ...
                        html:GeneralLayout.createBoxHelp('<img src="images/help.png">','toInternat:Ce panneau offre un ensemble de composants � int�grer dans le site final. <br>Cliquer sur les composants de l\'abre du haut pour les rajouter, cliquer sur les composants ajout�s dans l\'arbre du bas pour les supprimer. Une fois les �l�ments s�lectionn�s, exporter le site en cliquant sur le bouton Export dans la barre d\'outils au dessus de l\'arbre.'),
                        tbar: [xportAction]
                    });
                        ...
                        for (var i = 0; i < hosts.length; i++) {
                           ...
                           var actionTest = new Ext.Action({
                                                ...
                                                handler: function(){
                                                    ...
                                                    var mask = new Ext.LoadMask(Ext.getCmp('fsHost' + hid).getEl(),{msg:i18n.testing_server});
                                                    mask.show();
                                                    Ext.Ajax.request({
                                                        url:'testServer.do',
                                                        params: {'type':type,'recurse':recurse,'name':name,'path':path,'port':port,'uname':uname,'upwd':upwd, 'instance':instance},
           ...
           addComponent : function(cmp) {
               ...
               if(elt.split('_')[0] == 'OL') {
                   ...
                   if(elt == 'MF_NavToolbar') {
                       ...
                       GeneralLayout.publishertoolbar.addControl(new OpenLayers.Control.ZoomBox({isDefault: true}), {iconCls: 'bzoomin', toggleGroup: 'map'});
                       GeneralLayout.publishertoolbar.addControl(new OpenLayers.Control.ZoomBox({out:true}), {iconCls: 'bzoomout', toggleGroup: 'map'});
                       GeneralLayout.publishertoolbar.addControl(new OpenLayers.Control.DragPan(), {iconCls: 'bdrag', toggleGroup: 'map'});
