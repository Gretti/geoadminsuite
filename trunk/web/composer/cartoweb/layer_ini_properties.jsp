...
<html:html >
    <head><title><bean:message key="ms_layer_title"/></title>
        ...
        <script type="text/javascript">
            ...
            // shorthand
            var Tree = Ext.tree;
            // the global autoClassLegend value for this layers.ini
            // used as a shorthand for the same form property.
            // it is set by setLayerAttributes
            var autoClassLegend = false;
            ...
            function setLayerAttributes() {
                ...
                autoClassLegend = frm.elements['layerConf.autoClassLegend'].checked;
                ...
                if (!currentNode || !currentNode.attributes || !currentNode.attributes.cwattributes ) {
                    Ext.Msg.alert("Message","<bean:message key="cartoweb.layer.selectTreeNode"/>");
                    return;
                }
                var cmp;
            ...
            function sub() {
                ...
                Ext.Ajax.request({
                    ...
                    params: {'<%=ObjectKeys.CW_LAYER_TREE_JSON%>':stree, 'autoClassLegend' : autoClassLegend},
                    method: 'POST',
            ...
            function addCWNode(isLeaf) {
                Ext.Msg.prompt('Name', 'Please enter your name:', function(btn, text){
                    if (btn == 'ok') {
                        ...
                        var className = isLeaf ? 'Layer' : 'LayerGroup';
            ...
            function removeSelectedLayer() {
                Ext.MessageBox.confirm('<bean:message key="cartoweb.layer.removeLayer"/>', '<bean:message key="cartoweb.layer.removeLayer"/> ?', function(btn){
                    if(btn == 'yes') {
                        ...
                        document.forms[formName].removeNode.disabled = true;
                    };
                });
            }

            Ext.onReady(function(){
                if (Ext.getCmp('cw_layer_tree_panel') != null) {
                    Ext.getCmp('cw_layer_tree_panel').destroy();
                }
                if (Ext.getCmp('cw_layer_tree') != null) {
                    Ext.getCmp('cw_layer_tree').destroy();
                }
                cwtree = new Tree.TreePanel({
                    el:'tree-div',
                    id: 'cw_layer_tree_panel',
                    useArrows:true,
                    autoScroll:true,
                    animate:true,
                    enableDD:true,
    ...
    <html:form action="CWIniProperties.do" method="POST">
        <table class="tableb" cellpadding="0" cellspacing="1" width="100%">
            ...
            <tr>
                ...
                <td class="td4tiny">
                    <html:checkbox property="layerConf.autoClassLegend" value="true" styleClass="tiny" />
                </td>
            </tr>
            <tr>
