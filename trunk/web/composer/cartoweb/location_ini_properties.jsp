<%/*Copyright (C) 2007-2008  Gretti N'guessan, nicolas Ribot
    ...
    <head><title><bean:message key="ms_layer_title"/></title>
        ...
        <SCRIPT>
            ...
            function sub() {
                ...
                if (ok) {
                    GASselectAll(document.forms[formName].elements['locationConf.scalesAsString']);
                    GASselectAll(document.forms[formName].elements['locationConf.shortcutsAsString']);
                    Ext.Ajax.request({
        ...
        <table class="tableb" cellpadding="0" cellspacing="1" width="100%">
            ...
            <tr>
                <td class="td4tiny" colspan="2" align='center'>
                    ...
                    <input type="button" name="removeScaleBtn" value="Remove" onclick="GASremoveElement(document.forms[formName].elements['locationConf.scalesAsString'])" class="tiny"/>
            ...
            <tr>
                <td class="td4tiny" colspan="2" align='center'>
                    ...
                    <input type="button" name="removeShortcutBtn" value="Remove" onclick="GASremoveElement(document.forms[formName].elements['locationConf.shortcutsAsString'])" class="tiny"/>
