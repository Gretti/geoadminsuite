...
//    protected ShapeArc shapepl;
     ...
     */
    public Geometry(String id, int type, Extent extent, String className, Vector<Coord> points) {
...
//System.out.println("rebuildWKT: original WKT: " + wkt);
	 ...
	 * class constants
	 */
	public static String toOgisType(int type) {
		switch (type) {
		case Geometry.POINT:
			return "POINT";
	 ...
	 * @return
	 */
	public static int fromOgisType(String ogisType) {
		int type = -1;
