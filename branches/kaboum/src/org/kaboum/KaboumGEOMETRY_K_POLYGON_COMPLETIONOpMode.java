 ...
 *
 */
public class KaboumGEOMETRY_K_POLYGON_COMPLETIONOpMode extends KaboumGEOMETRY_K_POLYGON_SPLITTINGOpMode {
     ...
     *
     */
    public KaboumGEOMETRY_K_POLYGON_COMPLETIONOpMode(Kaboum parent) {
        super(parent, KaboumFeatureModes.K_POLYGON_COMPLETION);
    }
     ...
     *
     */
    public KaboumGEOMETRY_K_POLYGON_COMPLETIONOpMode(Kaboum parent, short OPERATION) {
        super(parent, KaboumFeatureModes.K_POLYGON_COMPLETION);
    }
