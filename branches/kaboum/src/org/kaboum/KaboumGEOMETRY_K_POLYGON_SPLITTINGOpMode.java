 ...
 *
 */
public class KaboumGEOMETRY_K_POLYGON_SPLITTINGOpMode extends KaboumOpMode {
    ...
    protected static KaboumGeometry holeFatherGeometry = null;
    
    /** if true current geometry drawn is a hole */
    protected static boolean holeDrawing = false;
    ...
    /** Current OPERATION */
    protected short OPERATION = KaboumFeatureModes.K_POLYGON_SPLITTING;
     ...
     *
     */
    public KaboumGEOMETRY_K_POLYGON_SPLITTINGOpMode(Kaboum parent) {
        this(parent, KaboumFeatureModes.K_POLYGON_SPLITTING);
    }
     ...
     *
     */
    public KaboumGEOMETRY_K_POLYGON_SPLITTINGOpMode(Kaboum parent, short OPERATION) {
        this.parent = parent;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("ADD_POINT")) {
            ...
            KaboumGEOMETRY_K_POLYGON_SPLITTINGOpMode.selectedGGD.setModified(false);
