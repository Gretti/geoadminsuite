...
public class Mapfile {
    ...
    public static String getExtent() {
        return extent;
    }

    /**
     * Returns the map extent srs, in the form init:EPSG=<value> based on layers extents
     */
     ...
     * @param layers
     * @return the layers extent as a mapserver string
     */
    public static String setExtentAndProjection(List<MSLayer> layers) {
        String ret = "";
