...
License
-------
The JUMP DB Query plugin is licensed under the GNU Lesser General Public 
License.   See the file COPYING.LESSER for more information.
...
Finally, support has been added for SpatiaLite. Download the SQLite JDBC
driver at http://www.zentus.com/sqlitejdbc/.  The JUMP DB Query Plugin was
tested with the SQLite pure java driver.
