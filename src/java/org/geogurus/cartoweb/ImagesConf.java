        ...
        while (e.hasMoreElements()) {
            ...
            if (keys.length > 2) {
                if ("mapSizes".equalsIgnoreCase(keys[0])) {
                    CartowebMapSize ms = getMapSizes().containsKey(keys[1]) ? 
                        getMapSizes().get(keys[1]) : 
                        new CartowebMapSize(keys[1]);
        ...
        if (mapSizesAsString != null) {
            ...
            for (String s : mapSizesAsString) {
                ...
                if (tok.countTokens() != 4) {
                    ...
                    t = tok.nextToken();
                    mapSize.setLabel("null".equalsIgnoreCase(t) || t.length() == 0 ? 
                        null : 
                        t);
                    t = tok.nextToken();
                    mapSize.setWidth("null".equalsIgnoreCase(t) || t.length() == 0 ? 
                        null : 
                        Integer.parseInt(t.trim()));
                    t = tok.nextToken();
                    mapSize.setHeight("null".equalsIgnoreCase(t) || t.length() == 0 ? 
                        null : 
                        Integer.parseInt(t.trim()));
