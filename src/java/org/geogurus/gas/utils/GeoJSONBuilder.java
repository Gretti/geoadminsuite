 ...
 * GeoJSONBuilder.java
 *
 * This code comes from GeoServer.
 */
...
public class GeoJSONBuilder extends JSONBuilder {
     ...
     */
    public JSONBuilder writeGeom(Geometry geometry) throws Exception {
        this.object();
        this.key("type");
    ...
    private JSONBuilder writeGeomCollection(GeometryCollection collection) throws Exception {
        this.array();
        this.key("geometries");
     ...
     * @throws JSONException
     */
    private void writePolygon(Polygon geometry) throws Exception {
        this.array();
