...
public interface JumpDbQuery
{
    ...
    /**
     * Tries to cancel a running query and returns any message generated by this operation
     * If the underlying database driver does not support statement.cancel() ...
     * @return the exception' message generated by calling statement.cancel()
     */
